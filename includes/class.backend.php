...
LEFT JOIN {users} u ON ass.user_id = u.user_id ';
	...
	if($conf['database']['dbtype']=='mysqli' || $conf['database']['dbtype']=='mysql' || $conf['database']['dbtype']=='pdo_mysql'){
		...
		# unsupported group_concat or we just do not know how write it for the other databasetypes in this section 
